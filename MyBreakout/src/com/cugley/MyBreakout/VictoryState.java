...
public class VictoryState extends FlxState
{
	...
	public void create()
	{
		...
		_gameOverText = new FlxText(0, FlxG.height/3, FlxG.width, "You Won!" );
		...
		_pressToContinueText = new FlxText(0, FlxG.height -24, FlxG.width, "Click to go back to the start");
